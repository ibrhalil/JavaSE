...
public class DosyaYazma {
	...
	public static void main(String[] args) {
		...
		dosya = new File("Bana Birþeyler Yaz.txt");
	...
	private static void dosyaYaz() throws Exception {
		...
		FileWriter yazdir = new FileWriter(dosya);				//üstüne yazar eski veriler gider
		//FileWriter yazdir = new FileWriter(dosya,true);		// üstüne ekleme yapar
