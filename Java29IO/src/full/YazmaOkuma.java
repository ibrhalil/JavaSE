...
public class YazmaOkuma {
	...
	public static void main(String[] args) {
		...
		System.err.println("program sonlandýrýldý");
	}
	...
	static void kontrol(File dosya) throws Exception
	{
		...
		if (yazOku(dosya)) {
			System.out.println("Dosya Adý    : "+dosya.getName());
		...
		{
			System.out.println(dosya.getName()+ " bu dosya yazýlamaz veya okunamaz.");
		}
	}
	...
	static void islem(File dosya) throws Exception
	{
		...
		System.out.println(" 4 - Dosya Güncelle");
		System.out.println(" q - Çýk\n");
	...
	static void islem1(File dosya) throws Exception{
		...
		{
			System.out.println("dosyanýn içi boþ");
		}
